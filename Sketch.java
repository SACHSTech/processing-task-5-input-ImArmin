...
public class Sketch extends PApplet {
  ...
  public void mouseWheel() {
    ...
    fill(255, 255, 0);
    rect(width/2, height/8, width/20, height/8);

    fill(255, 255, 0);
    rect((float) (width/1.33), height/8, width/20, height/8);
  }
  ...
  public void draw() {
    ...
    // Tree House
    fill(153, 102, 0);
    rect(width/10, (float) (height/2.48), width/8, height/20);
